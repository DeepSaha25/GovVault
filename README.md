...
| :--- | :--- | :--- | :--- | :--- |
| 1 | GCFN6KXFF2N3VLG5RGATNWQKOLLTZMWJZ6IMEPAYOV4TRAN4ZIZ3ICKA | Provide a simple visual slider... | Replaced numeric input with an interactive range slider for immediate visual feedback on quadratic cost. | [`860d2bd`](https://github.com/DeepSaha25/GovVault/commit/860d2bd) |
...
| 3 | GAGLBY4YKFF4MCZR7R7EL3TRXO6IZDEDXAN7WCEUL5PESAONLNTZ3WGV | The wallet connection was seamless, but a quick tutorial video... | Built an interactive Welcome Onboarding Modal to explain the quadratic voting mechanism to first-time users. | [`21bdb7a`](https://github.com/DeepSaha25/GovVault/commit/21bdb7a) |
| 4 | GDSROJIVVK73ZXBATMXYPKWTZGN4E245REKUONRE64EFKAYX3A3BXX57 | Consider making the dashboard a bit more mobile-responsive. | Enhanced the hero section and mobile responsiveness. | [`da98221`](https://github.com/DeepSaha25/GovVault/commit/da98221) |
| 5 | GDX2ILXF5EHCELK6KREHFGDFKPJMAH74FIATNESSVNKYD4LPPSAGZNGL | Loved the dark mode! It would be helpful to have an email notification... | Exposed the ThemeToggle and changed the default application theme to dark mode. | [`a61cdbe`](https://github.com/DeepSaha25/GovVault/commit/a61cdbe) |
| 6 | GCP4J7IRTEIWSEOUV54F2EP27QOANTF5H5UALZE5VDM3RWM4IXVMFDUZ | if you could add a progress bar showing total votes cast... | New reusable `VoteDistributionBar` component with animated yes/no progress bars. | [`65c2d2b`](https://github.com/DeepSaha25/GovVault/commit/65c2d2b) |
...
| 8 | GBZCJOUJQ65FPKOUUFCFLU2J7D5G52PGK4UNZ53ONH3FX6HQS67IGRGI | Adding a dedicated section for viewing past voting history... | Added a green "✓ You Voted" badge on proposal cards based on event log history. | [`89c9282`](https://github.com/DeepSaha25/GovVault/commit/89c9282) |
| 9 | GCWKLOJ2MOWBGR2WTWOHWORAKIEEOHVF2EL74XMVUPGZQHDR53UAQLVP | improve the UX | Added a dismissible welcome guide/info banner on the dashboard explaining rules. | [`d198c45`](https://github.com/DeepSaha25/GovVault/commit/d198c45) |
| 10 | GB444LXKMLLPXXEXYF7NSU2PEXK5NO3EX6WANIZY2GVGFSZMIXR3HWBU | the Ui can be made for simple | Added treasury stats overview panel to dashboard. | [`9ee8a7a`](https://github.com/DeepSaha25/GovVault/commit/9ee8a7a) |
